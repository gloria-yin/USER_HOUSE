...
1. 点击最上层且没有被上层卡牌重叠遮挡的卡牌。
2. 卡牌会进入下方 7 格槽。
3. 同图标凑满 3 张会自动消除。
4. 「移出」最多 3 次，可以把槽内卡牌移到上方 3 格暂存区，暂存区同样参与三消。
5. 「打乱」不限次数，会重排剩余牌面，结算时打乱越少分数越高。
6. 7 格槽满后再放入一张且没有形成三消时失败；全部消完则胜利。
...
- 内置单人游戏：俄罗斯方块、贪吃蛇、2048、合成大西瓜、翻牌记忆、跳一跳、搭木板、数独、U了个U。
- 内置双人游戏：双人飞行棋、猜数字、我说你猜、井字棋、五子棋、电子围地盘、抽鬼牌、翻转棋、数字炸弹、立体四子棋。

...
支持耍赖模式的双人游戏，每局最多可以点击 3 次「耍赖」撤销上一步操作。耍赖会触发专属语录，并在游戏日志里记录本局反悔次数；如果三次都用完还能获胜，会触发耍赖小剧场。
...
- 支持 4 套掌机风格主题、自定义字体、手机端和电脑端自适应布局。
